...
(defn emmy-viewers
  ...
  ([] :kind/emmy-viewers)
  ([value] (scicloj.kindly.v4.kind/emmy-viewers value nil))
  ([value options] (kindly/attach-meta-to-value value {:kindly/kind :kind/emmy-viewers :kindly/options options})))
